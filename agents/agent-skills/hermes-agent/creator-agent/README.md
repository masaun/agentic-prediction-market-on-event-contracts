...
|---|---|---|
| [SKILL.md](SKILL.md) | Hermes (the agent) | Role, tool table, market-creation workflow, gotchas — loaded into context when this skill activates |
...
```sh
tsx agents/agent-skills/hermes-agent/cli/index.ts create_market --agent hermes-creator \
...
[../../open-claw/creator-agent/README.md](../../open-claw/creator-agent/README.md) (same role, OpenClaw) ·
